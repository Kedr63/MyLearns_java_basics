...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        logger = LogManager.getRootLogger(); // лог можно получить из LogManager-а вызвав статический метод
        // например /getRootLogger/(корневой логер), можно вызывать разные логеры
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            logger.info("Станция не найдена: " + line); // добавили logger
