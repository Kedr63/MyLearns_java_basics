...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Эксперименты над настройкой log4j2

        logger = LogManager.getLogger(Main.class);
        System.out.println(Main.class.getPackageName().toString());

        logger.trace("это trace root");
        logger.debug("это debug root");
        logger.info("это info root");
        logger.warn("это warn root");
