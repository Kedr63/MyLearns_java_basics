...
public class Main {
    ...
    *  📍 Создадим файл конфигурации /hibernate.cfg.xml/ и обязательно в нем отредактировать свои данные (user, pass, БД, и
    *      указать с какой таблицой (или таблицами) будет работать (<mapping class="Course"/>))
