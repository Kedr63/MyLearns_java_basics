...
public class _1_FileWriteEx {
    public static void main(String[] args) throws IOException {
        ...
        /** Стрим (поток) для работы с файлами - это упорядоченная последовательность данных.
         ...
         В java разделяются стримы, которые работают с байтами и с какими-то символами
         (т/е с буквами, цифрами и тд)
        ...
        // ❤️Второй вариант: можем не создавать файл❗️, а указать в конструкторе файл /file2.txt/ без
        // абсолютного пути, и тогда 📌файл создастся в корне проекта❗️
