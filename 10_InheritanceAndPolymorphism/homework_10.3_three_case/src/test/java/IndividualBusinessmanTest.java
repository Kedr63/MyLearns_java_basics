...
public class IndividualBusinessmanTest {
    ...
    void putLess1000() {
        individualBusinessman.put(individualBusinessman,500.0);
    ...
    void put1000() {
        individualBusinessman.put(individualBusinessman,1000.0);
    ...
    void putMore1000() {
        individualBusinessman.put(individualBusinessman,2000.0);
    ...
    void putNegativeAmount() {
        individualBusinessman.put(individualBusinessman,-1.0);
    ...
    void take() {
        individualBusinessman.put(individualBusinessman,500.0); //положилось 495
        individualBusinessman.take(individualBusinessman,1.0);
    ...
    void takeTooMuchMoney() {
        individualBusinessman.put(individualBusinessman,500.0); //положилось 495
        individualBusinessman.take(individualBusinessman,496.0);
        assertEquals(495.0, individualBusinessman.getAmount(), DELTA, notExpectedSumMessage);
    }
}