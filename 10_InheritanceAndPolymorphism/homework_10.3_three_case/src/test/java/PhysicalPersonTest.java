...
public class PhysicalPersonTest {
    ...
    void put() {
        physicalPerson.put(physicalPerson,1.0);
    ...
    void take() {
        physicalPerson.put(physicalPerson,2.0);
        physicalPerson.take(physicalPerson, 1.0);
        assertEquals(1.0, physicalPerson.getAmount(), DELTA, notExpectedSumMessage);
    }
    ...
    void takeTooMuchMoney() {
        physicalPerson.put(physicalPerson,2.0);
        physicalPerson.take(physicalPerson,3.0);
