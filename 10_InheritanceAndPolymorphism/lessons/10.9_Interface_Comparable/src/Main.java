...
public class Main {
    public static void main(String[] args) {
        ...
        // по площади.
        // Соответственно, мы можем сделать так: прописать в них интерфейс /implements Comparable/, и он попросит
        ...
        // /implements Comparable<Square>/, поскольку он должен сраниваться не с объектом /Object o/, а с
