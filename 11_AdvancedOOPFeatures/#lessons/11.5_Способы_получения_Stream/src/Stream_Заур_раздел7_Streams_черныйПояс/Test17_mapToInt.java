...
public class Test17_mapToInt {
    public static void main(String[] args) {
        ...
        // Исппользуем mapToInt: что у нас int у студентов? ➔ например, номер курса ➔ /getCourse/.
        ...
        // а нам нужно конвентировать их в Integer. Этим и занимается метод /boxed/. Теперрь можем
